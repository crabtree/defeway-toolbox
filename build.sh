...
CGO_ENABLED=0 GOOS=darwin GOARCH=arm64 go build -o bin/defewaydownload-macos ./cmd/download
...
CGO_ENABLED=0 GOOS=darwin GOARCH=arm64 go build -o bin/defewayscan-macos ./cmd/scan
